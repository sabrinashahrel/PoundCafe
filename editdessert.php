...
{
$id=$_REQUEST['id'];
$namedessert =$_REQUEST['namedessert'];
$price =$_REQUEST['price'];

$update="update dessert set 
...
<label for="namedessert">Dessert:</label>
<p><input type="namedessert" name="namedessert" size="50" placeholder="Dessert" required value="<?php echo $row['namedessert'];?>" /></p>
